...
| [Waveshare ESP32-P4-Module](https://www.waveshare.com/esp32-p4-module.htm) and [module wiki](https://www.waveshare.com/wiki/ESP32-P4-Module) | vendor pages current at verification | 16/32-MB flash distinction, 32-MB PSRAM and default-pad versus resistor-switched IPEX antenna routing |
| [Amazon UK accessory selections](13-amazon-uk-shopping-list.md) | ASIN, title, visible price and Prime delivery verified 2026-08-08 | current shopping snapshot for camera, power, cables, breakout, storage and soldering bench; recheck at checkout |
| [Arducam LK001 M12 lens-kit specification](https://blog.arducam.com/doc/m12_lens_kit.pdf) and [LK002 low-distortion specification](https://blog.arducam.com/doc/m12_lens_kit_2.pdf) | manufacturer lens tables current at verification | M12 optical formats, focal lengths, fields of view, holders and IR-filter characteristics for OV5647 lens experimentation |
| [Waveshare ESP32-P4-Module-DEV-KIT product](https://www.waveshare.com/esp32-p4-module-dev-kit.htm) and [documentation](https://docs.waveshare.com/ESP32-P4-Module-DEV-KIT) | vendor pages current at verification | exact selected board, 360-MHz P4, 32-MB PSRAM, 16-MB flash, ESP32-C6, MIPI CSI/DSI, OV5647 compatibility, SMD antenna and official package contents |
| [Amazon UK ESP32-P4-Module-DEV-KIT listing](https://www.amazon.co.uk/gp/product/B0FPG45999) | ASIN `B0FPG45999`, price, Prime and visible stock inspected 2026-08-08 | identifies the user's base development-board selection; not used as technical authority and does not clearly list a supplied camera |
